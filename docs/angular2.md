...
- [High-quality, modular starter (seed) project for Angular 2 apps with statically typed build and AoT](https://github.com/mgechev/angular2-seed)
- [Angular 2 JumpStart with ES5](https://github.com/albertosantini/angular2-es5-jumpstart)
